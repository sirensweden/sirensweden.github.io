...
<img src="../img/20260527.jpeg" alt="Group picture of the Signal 2026 attendees" width="34%" height="auto">
<img src="../img/20260528.jpg" alt="Guest session with Fabiano Dalpiaz" width="60%" height="auto">
...
* Decision on next SiGNAL and SPC. 
  ...
  - proposal: 2028 Malmö, Docent Romina Spalazzese
    - decision: passed by acclamation
* Decision on new node and Node Representative (NR):
  - proposal: Uppsala is included as a new node
    - decision: passed by acclamation
  - proposal: new NR [Assoc. Prof. Sofia Ouhbi](https://www.uu.se/en/contact-and-organisation/staff?query=N22-2414) of Uppsala
    - decision: passed by acclamation
* Decision on SCC for next 2 years (until Signal 2028)
  - proposal: Prof. Bjorn Regnell
    - decision: passed by acclamation
* Any Other Business
  - Discussion on how to elicit more PhD students and local industry participation.
  - Discussion on nomination of industry ambassadors, e.g. from RISE.